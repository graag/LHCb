...
gROOT.ProcessLine(".L ../RooCutCBShape.cxx+")

from ROOT import RooCutCBShape
...
p1 = RooCutCBShape( 'double_crystal_ball', 'PDF', \
        x, mean, sigma, alpha, beta, n1)
